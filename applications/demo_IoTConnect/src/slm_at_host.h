...
/**@brief Function to retrieve LTE mode to use in demo proper. */
typedef void (*mode_retrieve_handler_t)(uint8_t *mode);

/**@brief Function to store LTE mode to use in demo proper  */
typedef int (*mode_store_handler_t)(uint8_t mode);
